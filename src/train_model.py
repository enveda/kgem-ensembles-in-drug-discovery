...
Ex. >> run_pykeen(
        train_file_path='../data/model_data/custom_train.tsv',
        test_file_path='../data/model_data/custom_test.tsv',
        val_file_path='../data/model_data/custom_val.tsv',
...
def run_pykeen(
    ...
    """
    with open(os.path.join(PROJECT_DIR, 'kgem-params', f'{configuration}.json'), 'r') as config_file:
